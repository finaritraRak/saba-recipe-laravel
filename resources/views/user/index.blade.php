...
<div class="card mb-3 mb-md-4">
	...
	<div class="card-body">
		...
		<div class="mb-3 mb-md-4 d-flex justify-content-between">
			...
			<a href="{{ URL::to('/users/create') }}" class="btn btn-primary">
				Add new
			</a>
		</div>
				...
				<tr>
					...
					<td class="py-3">
						<div class="position-relative">
							<a class="link-dark d-inline-block" href="{{ url('/users/edit/' . $user->id) }}">
							...
							<form id="delete-entity-{{ $user->id }}" action="{{ url('/users/delete/' . $user->id) }}', $user" method="POST">
